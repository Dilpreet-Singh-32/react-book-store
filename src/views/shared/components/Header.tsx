...
export const Header: React.FunctionComponent<HeaderProps> = () => {
  ...
  return (
    <>
            ...
            <div className="col-lg-8 d-none d-lg-block">
              <nav className="mainmenu__nav">
                <ul className="meninmenu d-flex justify-content-start">
                  ...
                  <li className="drop">
                    <a href="shop-grid.html">Authors</a>
      ...
      <div className={searchModalClasses}>
        ...
        <div className="close__wrap" onClick={toggleSearching}>
          <span>close</span>
          <span>
            <i className="fa fa-times fa-lg" style={{ marginLeft: '10px' }}></i>
          </span>
        </div>
      </div>
    </>
